...
int main( void )
{
    ...
    do{
        GLfloat radius = 5.0f;
        GLfloat camX = sin(glfwGetTime()) * radius * 1.5;
        GLfloat camZ = cos(glfwGetTime()) * radius * 1.5;

        View = glm::lookAt(glm::vec3(camX, 0.0, camZ), glm::vec3(0.0, 0.0, 0.4), glm::vec3(0.0, 1.0, 0.0));
